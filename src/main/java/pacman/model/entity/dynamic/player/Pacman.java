...
import pacman.model.entity.dynamic.player.observer.PlayerDirectionObserver;
...
public class Pacman implements Controllable, PlayerPositionSubject {
    ...
    private final Set<PlayerDirectionObserver> directionObservers;
    ...
    public Pacman(
        ...
        this.directionObservers = new HashSet<>();
    ...
    @Override
    public void registerDirectionObserver(PlayerDirectionObserver observer) {
        this.directionObservers.add(observer);
        observer.update(this.kinematicState.getDirection());
    }

    @Override
    public void removeDirectionObserver(PlayerDirectionObserver observer) {
        this.directionObservers.remove(observer);
    }
    ...
    public void notifyObservers() {
        ...
        for (PlayerDirectionObserver playerDirectionObserver : directionObservers) {
            playerDirectionObserver.update(this.kinematicState.getDirection());
        }
    }
