...
public interface Level extends LevelStateSubject {
    ...
    /**
     * Instructs the Level object to add points for ghosts eaten
     */
    void addGhostEatingPoints();

    /**
     * Instructs the Level object to increase the number of consecutive ghosts eaten
     */
    void addConsecutiveGhostsEaten();
}
